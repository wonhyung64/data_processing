...
def deserialize_example(serialized_string):
    image_feature_description = { 
        ...
        'filname': tf.io.FixedLenFeauture([], tf.string),
    } 
...
def read_labels(label_dir):
    ...
    return labels
#%%
save_dir = "/Users/wonhyung64/data/ship"
file_dir = "/Users/wonhyung64/data"
# file_dir = "C:/won/data"
split = "train"

if os.path.exists(f"{save_dir}/{split}.tfrecord".encode("utf-8")) == False:
    try_num = 0
    label_dict = {}
    filename_lst = []
    file_dir1 = file_dir
    ...
    file_dir2_conts.remove(".DS_Store")
    ...
    for i in range(len(file_dir2_conts)):
        ...
        for j in range(len(file_dir3_conts)):
            ...
            filename_lst = list(set([file_dir4_conts[l][:33] for l in range(len(file_dir4_conts))]))
